...
# Menu bar
    ...
    # Options
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        help_option.add_command(label="About LPU", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("About LPU", "'LPU is Ranked 36th Amongst Top Universities In India\n\nas per Times Higher Education World University Rankings 2022\n\nLPU is Ranked 2nd In Business & Economics Subject In India\n\nas per Times Higher Education World University Rankings 2022\n\nLPU is Ranked 8th In Clinical & Health Sciences Subject In India\n\nas per Times Higher Education World University Rankings 2022\n\nLPU is Ranked 9th In Computer Science Subject in India\n\nas per Times Higher Education World University Rankings 2022\n\nLPU is Ranked 10th in Life Sciences & Engineering Subjects in India\n\nas per Times Higher Education World University Rankings 2022\n\nLPU is 62nd in the University category amongst all Government and Private institutions in India\n\nas per NIRF Ranking 2021 released by Ministry of Education, Govt.', 'of India\n\nSchool of Architecture is ranked 12th amongst all Government and Private Architecture Institutions in India\n\nas per NIRF 2021 Rankings released by Ministry of Education, Govt.', 'of India\n\nSchool of Pharmacy is ranked 23rd amongst all Government and Private Pharmacy Institutions in India\n\nas per NIRF 2021 Rankings released by Ministry of Education, Govt.', 'of India\n\nSchool of Law is ranked 24th amongst all Government and Private Law Institutions in India\n\nas per NIRF 2021 Rankings released by Ministry of Education, Govt.', 'of India\n\nMittal School of Business is ranked 37th amongst all Government and Private Management Institutions in India\n\nas per NIRF 2021 Rankings released by Ministry of Education, Govt.', 'of India\n\nFaculty of Engineering is ranked 66th amongst all Government and Private Engineering Institutions in India\n\nas per NIRF 2021 Rankings released by Ministry of Education, Govt.', 'of India'")

    def about(self):
        tkinter.messagebox.showinfo("LpuMate",'Designed by Deepika')
...
Label(root, text="Hey this is LPU service for students I will guide a way for your queries\n and if you want to exit type bye.").pack(pady=10)
root.configure(bg='#FFD580')

a = ChatInterface(root)
root.geometry(window_size)
root.title("Welcome to Lpu services")

#mylabel = Label(root,text="Hey this is LPU service for students I will guide a way for your queries , if you want to exit type bye.")
